/* Process model C form file: pri_proc_lwsn_woStatWire.pr.c */
/* Portions of this file copyright 1986-2008 by OPNET Technologies, Inc. */



/* This variable carries the header into the object file */
const char pri_proc_lwsn_woStatWire_pr_c [] = "MIL_3_Tfile_Hdr_ 145A 30A modeler 7 562A96DB 562A96DB 1 wpd FeiTong 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 1e80 8                                                                                                                                                                                                                                                                                                                                                                                                              ";
#include <string.h>
...
#define track_cycles_num        		op_sv_ptr->track_cycles_num
#define cycles_num_lower        		op_sv_ptr->cycles_num_lower
#define cycles_num_upper        		op_sv_ptr->cycles_num_upper
#define avg_hop_duty_cycle_handle		op_sv_ptr->avg_hop_duty_cycle_handle
#define accumulated_service_time_handle		op_sv_ptr->accumulated_service_time_handle
...
#define FIN_PREAMBLE_DEC	pri_proc_lwsn_woStatWire_state *op_sv_ptr;
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((pri_proc_lwsn_woStatWire_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
//body
	...
	//stat_based_on_prob();//calculate delay based on probability
...
extern "C" {
#endif
	void pri_proc_lwsn_woStatWire (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Obtype _op_pri_proc_lwsn_woStatWire_init (int * init_block_ptr);
	void _op_pri_proc_lwsn_woStatWire_diag (OP_SIM_CONTEXT_ARG_OPT);
	void _op_pri_proc_lwsn_woStatWire_terminate (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Address _op_pri_proc_lwsn_woStatWire_alloc (VosT_Obtype, int);
	void _op_pri_proc_lwsn_woStatWire_svar (void *, const char *, void **);
...
void
pri_proc_lwsn_woStatWire (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (pri_proc_lwsn_woStatWire ());
		...
		FSM_ENTER ("pri_proc_lwsn_woStatWire")

		FSM_BLOCK_SWITCH
			{
			/*---------------------------------------------------------*/
			/** state (init) enter executives **/
			FSM_STATE_ENTER_FORCED_NOLABEL (0, "init", "pri_proc_lwsn_woStatWire [init enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [init enter execs]", state0_enter_exec)
				{
				// Obtain related ID
			...
			FSM_STATE_EXIT_FORCED (0, "init", "pri_proc_lwsn_woStatWire [init exit execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [init exit execs]", state0_exit_exec)
				{
				/*
			...
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "init", "idle", "tr_1", "pri_proc_lwsn_woStatWire [init -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (idle) enter executives **/
			FSM_STATE_ENTER_UNFORCED (1, "idle", state1_enter_exec, "pri_proc_lwsn_woStatWire [idle enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [idle enter execs]", state1_enter_exec)
				{
				///*
				if(CHECK_CHANNEL){
					if(op_ev_valid(send_gm_event)){
			...
			FSM_EXIT (3,"pri_proc_lwsn_woStatWire")


			/** state (idle) exit executives **/
			FSM_STATE_EXIT_UNFORCED (1, "idle", "pri_proc_lwsn_woStatWire [idle exit execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [idle exit execs]", state1_exit_exec)
				{
				/*
				if(node_type!=sink)
					grade=1;
			...
			FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [idle trans conditions]", state1_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 6, state6_enter_exec, ;, "CONTEND_TO_SEND_RTS", "", "idle", "T:second contention", "tr_28", "pri_proc_lwsn_woStatWire [idle -> T:second contention : CONTEND_TO_SEND_RTS / ]")
				FSM_CASE_TRANSIT (1, 4, state4_enter_exec, ;, "GO_TO_SLEEP", "", "idle", "sleeping_S", "tr_32", "pri_proc_lwsn_woStatWire [idle -> sleeping_S : GO_TO_SLEEP / ]")
				FSM_CASE_TRANSIT (2, 5, state5_enter_exec, ;, "WAKING_TO_WAIT_RTS", "", "idle", "R:waking", "tr_34", "pri_proc_lwsn_woStatWire [idle -> R:waking : WAKING_TO_WAIT_RTS / ]")
				FSM_CASE_TRANSIT (3, 16, state16_enter_exec, ;, "START_GRADE", "", "idle", "start grade", "tr_97", "pri_proc_lwsn_woStatWire [idle -> start grade : START_GRADE / ]")
				FSM_CASE_TRANSIT (4, 3, state3_enter_exec, ;, "SEND_GM", "", "idle", "send gm", "tr_100", "pri_proc_lwsn_woStatWire [idle -> send gm : SEND_GM / ]")
				FSM_CASE_TRANSIT (5, 2, state2_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "idle", "GM proc", "tr_102", "pri_proc_lwsn_woStatWire [idle -> GM proc : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (6, 1, state1_enter_exec, ;, "default", "", "idle", "idle", "tr_108", "pri_proc_lwsn_woStatWire [idle -> idle : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (2, "GM proc", state2_enter_exec, "pri_proc_lwsn_woStatWire [GM proc enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [GM proc enter execs]", state2_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (2, "GM proc", "pri_proc_lwsn_woStatWire [GM proc exit execs]")


			/** state (GM proc) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "GM proc", "idle", "tr_103", "pri_proc_lwsn_woStatWire [GM proc -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (send gm) enter executives **/
			FSM_STATE_ENTER_FORCED (3, "send gm", state3_enter_exec, "pri_proc_lwsn_woStatWire [send gm enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [send gm enter execs]", state3_enter_exec)
				{
				if(op_subq_empty(grade_queue) == OPC_FALSE)
				{
			...
			FSM_STATE_EXIT_FORCED (3, "send gm", "pri_proc_lwsn_woStatWire [send gm exit execs]")


			/** state (send gm) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send gm", "idle", "tr_101", "pri_proc_lwsn_woStatWire [send gm -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (sleeping_S) enter executives **/
			FSM_STATE_ENTER_UNFORCED (4, "sleeping_S", state4_enter_exec, "pri_proc_lwsn_woStatWire [sleeping_S enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [sleeping_S enter execs]", state4_enter_exec)
				{
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (9,"pri_proc_lwsn_woStatWire")


			/** state (sleeping_S) exit executives **/
			FSM_STATE_EXIT_UNFORCED (4, "sleeping_S", "pri_proc_lwsn_woStatWire [sleeping_S exit execs]")


			/** state (sleeping_S) transition processing **/
			FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [sleeping_S trans conditions]", state4_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 5, state5_enter_exec, ;, "WAKING_UP", "", "sleeping_S", "R:waking", "tr_37", "pri_proc_lwsn_woStatWire [sleeping_S -> R:waking : WAKING_UP / ]")
				FSM_CASE_TRANSIT (1, 6, state6_enter_exec, ;, "WAKING_TO_SEND_RTS", "", "sleeping_S", "T:second contention", "tr_40", "pri_proc_lwsn_woStatWire [sleeping_S -> T:second contention : WAKING_TO_SEND_RTS / ]")
				FSM_CASE_TRANSIT (2, 4, state4_enter_exec, ;, "default", "", "sleeping_S", "sleeping_S", "tr_91", "pri_proc_lwsn_woStatWire [sleeping_S -> sleeping_S : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (5, "R:waking", state5_enter_exec, "pri_proc_lwsn_woStatWire [R:waking enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [R:waking enter execs]", state5_enter_exec)
				{
				//Log record
			...
			FSM_STATE_EXIT_FORCED (5, "R:waking", "pri_proc_lwsn_woStatWire [R:waking exit execs]")


			/** state (R:waking) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "R:waking", "R:first", "tr_57", "pri_proc_lwsn_woStatWire [R:waking -> R:first : default / ]")
				/*---------------------------------------------------------*/



			/** state (T:second contention) enter executives **/
			FSM_STATE_ENTER_FORCED (6, "T:second contention", state6_enter_exec, "pri_proc_lwsn_woStatWire [T:second contention enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [T:second contention enter execs]", state6_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (6, "T:second contention", "pri_proc_lwsn_woStatWire [T:second contention exit execs]")


			/** state (T:second contention) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "T:second contention", "T:second", "tr_59", "pri_proc_lwsn_woStatWire [T:second contention -> T:second : default / ]")
				/*---------------------------------------------------------*/



			/** state (wait CTS) enter executives **/
			FSM_STATE_ENTER_FORCED (7, "wait CTS", state7_enter_exec, "pri_proc_lwsn_woStatWire [wait CTS enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [wait CTS enter execs]", state7_enter_exec)
				{
				//send RTS
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (7, "wait CTS", "pri_proc_lwsn_woStatWire [wait CTS exit execs]")


			/** state (wait CTS) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "wait CTS", "T:second", "tr_89", "pri_proc_lwsn_woStatWire [wait CTS -> T:second : default / ]")
				/*---------------------------------------------------------*/



			/** state (R:first) enter executives **/
			FSM_STATE_ENTER_UNFORCED (8, "R:first", state8_enter_exec, "pri_proc_lwsn_woStatWire [R:first enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [R:first enter execs]", state8_enter_exec)
				{
				//Received DATA from upper layer
				if(FROM_UPPER)
				{
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (17,"pri_proc_lwsn_woStatWire")


			/** state (R:first) exit executives **/
			FSM_STATE_EXIT_UNFORCED (8, "R:first", "pri_proc_lwsn_woStatWire [R:first exit execs]")


			/** state (R:first) transition processing **/
			FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [R:first trans conditions]", state8_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 4, state4_enter_exec, average_R_T(1);;, "SLEEP_FROM_FIRST", "average_R_T(1);", "R:first", "sleeping_S", "tr_56", "pri_proc_lwsn_woStatWire [R:first -> sleeping_S : SLEEP_FROM_FIRST / average_R_T(1);]")
				FSM_CASE_TRANSIT (1, 12, state12_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "R:first", "RCV(1)", "tr_74", "pri_proc_lwsn_woStatWire [R:first -> RCV(1) : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (2, 13, state13_enter_exec, ;, "SEND_CTS", "", "R:first", "wait DATA", "tr_76", "pri_proc_lwsn_woStatWire [R:first -> wait DATA : SEND_CTS / ]")
				FSM_CASE_TRANSIT (3, 14, state14_enter_exec, ;, "SEND_ACK", "", "R:first", "send ACK", "tr_79", "pri_proc_lwsn_woStatWire [R:first -> send ACK : SEND_ACK / ]")
				FSM_CASE_TRANSIT (4, 8, state8_enter_exec, ;, "default", "", "R:first", "R:first", "tr_90", "pri_proc_lwsn_woStatWire [R:first -> R:first : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_UNFORCED (9, "T:second", state9_enter_exec, "pri_proc_lwsn_woStatWire [T:second enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [T:second enter execs]", state9_enter_exec)
				{
				//Received DATA from upper layer
				if(FROM_UPPER)
				{
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (19,"pri_proc_lwsn_woStatWire")


			/** state (T:second) exit executives **/
			FSM_STATE_EXIT_UNFORCED (9, "T:second", "pri_proc_lwsn_woStatWire [T:second exit execs]")


			/** state (T:second) transition processing **/
			FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [T:second trans conditions]", state9_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 7, state7_enter_exec, ;, "SEND_RTS", "", "T:second", "wait CTS", "tr_60", "pri_proc_lwsn_woStatWire [T:second -> wait CTS : SEND_RTS / ]")
				FSM_CASE_TRANSIT (1, 4, state4_enter_exec, increase_ExpCyc_in_q();average_R_T(2);;, "SLEEP_FROM_SECOND", "increase_ExpCyc_in_q();average_R_T(2);", "T:second", "sleeping_S", "tr_61", "pri_proc_lwsn_woStatWire [T:second -> sleeping_S : SLEEP_FROM_SECOND / increase_ExpCyc_in_q();average_R_T(2);]")
				FSM_CASE_TRANSIT (2, 10, state10_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "T:second", "RCV(2)", "tr_66", "pri_proc_lwsn_woStatWire [T:second -> RCV(2) : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (3, 11, state11_enter_exec, ;, "SEND_DATA", "", "T:second", "send data", "tr_72", "pri_proc_lwsn_woStatWire [T:second -> send data : SEND_DATA / ]")
				FSM_CASE_TRANSIT (4, 15, state15_enter_exec, ;, "CHECK_CHANNEL", "", "T:second", "carrier sense(2)", "tr_95", "pri_proc_lwsn_woStatWire [T:second -> carrier sense(2) : CHECK_CHANNEL / ]")
				FSM_CASE_TRANSIT (5, 9, state9_enter_exec, ;, "default", "", "T:second", "T:second", "tr_92", "pri_proc_lwsn_woStatWire [T:second -> T:second : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (10, "RCV(2)", state10_enter_exec, "pri_proc_lwsn_woStatWire [RCV(2) enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [RCV(2) enter execs]", state10_enter_exec)
				{
				if(pk_TV!=NULL)
				{
					op_pk_destroy(pk_TV);
			...
			FSM_STATE_EXIT_FORCED (10, "RCV(2)", "pri_proc_lwsn_woStatWire [RCV(2) exit execs]")


			/** state (RCV(2)) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "RCV(2)", "T:second", "tr_71", "pri_proc_lwsn_woStatWire [RCV(2) -> T:second : default / ]")
				/*---------------------------------------------------------*/



			/** state (send data) enter executives **/
			FSM_STATE_ENTER_FORCED (11, "send data", state11_enter_exec, "pri_proc_lwsn_woStatWire [send data enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [send data enter execs]", state11_enter_exec)
				{
				//send DATA
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (11, "send data", "pri_proc_lwsn_woStatWire [send data exit execs]")


			/** state (send data) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "send data", "T:second", "tr_73", "pri_proc_lwsn_woStatWire [send data -> T:second : default / ]")
				/*---------------------------------------------------------*/



			/** state (RCV(1)) enter executives **/
			FSM_STATE_ENTER_FORCED (12, "RCV(1)", state12_enter_exec, "pri_proc_lwsn_woStatWire [RCV(1) enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [RCV(1) enter execs]", state12_enter_exec)
				{
				if(pk_TV!=NULL)
				{
					op_pk_destroy(pk_TV);
			...
			FSM_STATE_EXIT_FORCED (12, "RCV(1)", "pri_proc_lwsn_woStatWire [RCV(1) exit execs]")


			/** state (RCV(1)) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "RCV(1)", "R:first", "tr_75", "pri_proc_lwsn_woStatWire [RCV(1) -> R:first : default / ]")
				/*---------------------------------------------------------*/



			/** state (wait DATA) enter executives **/
			FSM_STATE_ENTER_FORCED (13, "wait DATA", state13_enter_exec, "pri_proc_lwsn_woStatWire [wait DATA enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [wait DATA enter execs]", state13_enter_exec)
				{
				//send CTS
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (13, "wait DATA", "pri_proc_lwsn_woStatWire [wait DATA exit execs]")


			/** state (wait DATA) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "wait DATA", "R:first", "tr_77", "pri_proc_lwsn_woStatWire [wait DATA -> R:first : default / ]")
				/*---------------------------------------------------------*/



			/** state (send ACK) enter executives **/
			FSM_STATE_ENTER_FORCED (14, "send ACK", state14_enter_exec, "pri_proc_lwsn_woStatWire [send ACK enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [send ACK enter execs]", state14_enter_exec)
				{
				//send ACK
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (14, "send ACK", "pri_proc_lwsn_woStatWire [send ACK exit execs]")


			/** state (send ACK) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "send ACK", "R:first", "tr_80", "pri_proc_lwsn_woStatWire [send ACK -> R:first : default / ]")
				/*---------------------------------------------------------*/



			/** state (carrier sense(2)) enter executives **/
			FSM_STATE_ENTER_FORCED (15, "carrier sense(2)", state15_enter_exec, "pri_proc_lwsn_woStatWire [carrier sense(2) enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [carrier sense(2) enter execs]", state15_enter_exec)
				{
				if(DEBUG_3RD)
			...
			FSM_STATE_EXIT_FORCED (15, "carrier sense(2)", "pri_proc_lwsn_woStatWire [carrier sense(2) exit execs]")


			/** state (carrier sense(2)) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "carrier sense(2)", "T:second", "tr_116", "pri_proc_lwsn_woStatWire [carrier sense(2) -> T:second : default / ]")
				/*---------------------------------------------------------*/



			/** state (start grade) enter executives **/
			FSM_STATE_ENTER_FORCED (16, "start grade", state16_enter_exec, "pri_proc_lwsn_woStatWire [start grade enter execs]")
				FSM_PROFILE_SECTION_IN ("pri_proc_lwsn_woStatWire [start grade enter execs]", state16_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (16, "start grade", "pri_proc_lwsn_woStatWire [start grade exit execs]")


			/** state (start grade) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "start grade", "idle", "tr_98", "pri_proc_lwsn_woStatWire [start grade -> idle : default / ]")
				/*---------------------------------------------------------*/
		...
		FSM_EXIT (0,"pri_proc_lwsn_woStatWire")
		}
	}
...
void
_op_pri_proc_lwsn_woStatWire_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_pri_proc_lwsn_woStatWire_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_pri_proc_lwsn_woStatWire_terminate ())
...
/* local variable prs_ptr in _op_pri_proc_lwsn_woStatWire_svar function. */
#undef process_id
#undef node_id
#undef node_address
#undef grade
...
#undef track_cycles_num
#undef cycles_num_lower
#undef cycles_num_upper
#undef avg_hop_duty_cycle_handle
#undef accumulated_service_time_handle
...
VosT_Obtype
_op_pri_proc_lwsn_woStatWire_init (int * init_block_ptr)
	{
	VosT_Obtype obtype = OPC_NIL;
	FIN_MT (_op_pri_proc_lwsn_woStatWire_init (init_block_ptr))

	obtype = Vos_Define_Object_Prstate ("proc state vars (pri_proc_lwsn_woStatWire)",
		sizeof (pri_proc_lwsn_woStatWire_state));
	*init_block_ptr = 0;
...
VosT_Address
_op_pri_proc_lwsn_woStatWire_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	pri_proc_lwsn_woStatWire_state * ptr;
	FIN_MT (_op_pri_proc_lwsn_woStatWire_alloc (obtype))

	ptr = (pri_proc_lwsn_woStatWire_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "pri_proc_lwsn_woStatWire [init enter execs]";
#endif
		}
...
void
_op_pri_proc_lwsn_woStatWire_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	{
	pri_proc_lwsn_woStatWire_state		*prs_ptr;

	FIN_MT (_op_pri_proc_lwsn_woStatWire_svar (gen_ptr, var_name, var_p_ptr))
	...
	prs_ptr = (pri_proc_lwsn_woStatWire_state *)gen_ptr;
	...
	if (strcmp ("track_cycles_num" , var_name) == 0)
		{
		*var_p_ptr = (void *) (&prs_ptr->track_cycles_num);
		FOUT
		}
	if (strcmp ("cycles_num_lower" , var_name) == 0)
		{
		*var_p_ptr = (void *) (&prs_ptr->cycles_num_lower);
		FOUT
		}
	if (strcmp ("cycles_num_upper" , var_name) == 0)
		{
		*var_p_ptr = (void *) (&prs_ptr->cycles_num_upper);
		FOUT
		}
	...
	if (strcmp ("accumulated_service_time_handle" , var_name) == 0)
		{
		*var_p_ptr = (void *) (&prs_ptr->accumulated_service_time_handle);
		FOUT
		}
	*var_p_ptr = (void *)OPC_NIL;
