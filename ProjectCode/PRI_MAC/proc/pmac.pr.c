/* Process model C form file: pmac.pr.c */
/* Portions of this file copyright 1986-2008 by OPNET Technologies, Inc. */



/* This variable carries the header into the object file */
const char pmac_pr_c [] = "MIL_3_Tfile_Hdr_ 145A 30A modeler 7 51B4A2A0 51B4A2A0 1 wpd FeiTong 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 1e80 8                                                                                                                                                                                                                                                                                                                                                                                                              ";
#include <string.h>
...
#define FIN_PREAMBLE_DEC	pmac_state *op_sv_ptr;
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((pmac_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
extern "C" {
#endif
	void pmac (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Obtype _op_pmac_init (int * init_block_ptr);
	void _op_pmac_diag (OP_SIM_CONTEXT_ARG_OPT);
	void _op_pmac_terminate (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Address _op_pmac_alloc (VosT_Obtype, int);
	void _op_pmac_svar (void *, const char *, void **);
...
pmac (OP_SIM_CONTEXT_ARG_OPT)
	...
	FIN_MT (pmac ());
		...
		FSM_BLOCK_SWITCH
			...
			FSM_STATE_ENTER_FORCED_NOLABEL (0, "init", "pmac [init enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [init enter execs]", state0_enter_exec)
				{
				// Obtain related ID
			...
			FSM_STATE_EXIT_FORCED (0, "init", "pmac [init exit execs]")
				FSM_PROFILE_SECTION_IN ("pmac [init exit execs]", state0_exit_exec)
				{
				/*
			...
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "init", "idle", "tr_1", "pmac [init -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (idle) enter executives **/
			FSM_STATE_ENTER_UNFORCED (1, "idle", state1_enter_exec, "pmac [idle enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [idle enter execs]", state1_enter_exec)
				{
				if(END)
				{
				/*
			...
			FSM_STATE_EXIT_UNFORCED (1, "idle", "pmac [idle exit execs]")
				FSM_PROFILE_SECTION_IN ("pmac [idle exit execs]", state1_exit_exec)
				{
			...
			FSM_PROFILE_SECTION_IN ("pmac [idle trans conditions]", state1_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 6, state6_enter_exec, ;, "CONTEND_TO_SEND_RTS", "", "idle", "second contention", "tr_28", "pmac [idle -> second contention : CONTEND_TO_SEND_RTS / ]")
				FSM_CASE_TRANSIT (1, 4, state4_enter_exec, ;, "GO_TO_SLEEP", "", "idle", "sleeping", "tr_32", "pmac [idle -> sleeping : GO_TO_SLEEP / ]")
				FSM_CASE_TRANSIT (2, 5, state5_enter_exec, ;, "WAKING_TO_WAIT_RTS", "", "idle", "waking", "tr_34", "pmac [idle -> waking : WAKING_TO_WAIT_RTS / ]")
				FSM_CASE_TRANSIT (3, 17, state17_enter_exec, ;, "START_GRADE", "", "idle", "start grade", "tr_97", "pmac [idle -> start grade : START_GRADE / ]")
				FSM_CASE_TRANSIT (4, 3, state3_enter_exec, ;, "SEND_GM", "", "idle", "send gm", "tr_100", "pmac [idle -> send gm : SEND_GM / ]")
				FSM_CASE_TRANSIT (5, 2, state2_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "idle", "GM proc", "tr_102", "pmac [idle -> GM proc : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (6, 1, state1_enter_exec, ;, "default", "", "idle", "idle", "tr_99", "pmac [idle -> idle : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (2, "GM proc", state2_enter_exec, "pmac [GM proc enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [GM proc enter execs]", state2_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (2, "GM proc", "pmac [GM proc exit execs]")


			/** state (GM proc) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "GM proc", "idle", "tr_103", "pmac [GM proc -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (send gm) enter executives **/
			FSM_STATE_ENTER_FORCED (3, "send gm", state3_enter_exec, "pmac [send gm enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [send gm enter execs]", state3_enter_exec)
				{
				if(op_subq_empty(grade_queue) == OPC_FALSE)
				{
			...
			FSM_STATE_EXIT_FORCED (3, "send gm", "pmac [send gm exit execs]")


			/** state (send gm) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send gm", "idle", "tr_101", "pmac [send gm -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (sleeping) enter executives **/
			FSM_STATE_ENTER_UNFORCED (4, "sleeping", state4_enter_exec, "pmac [sleeping enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [sleeping enter execs]", state4_enter_exec)
				{
			...
			FSM_STATE_EXIT_UNFORCED (4, "sleeping", "pmac [sleeping exit execs]")


			/** state (sleeping) transition processing **/
			FSM_PROFILE_SECTION_IN ("pmac [sleeping trans conditions]", state4_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 5, state5_enter_exec, ;, "WAKING_UP", "", "sleeping", "waking", "tr_37", "pmac [sleeping -> waking : WAKING_UP / ]")
				FSM_CASE_TRANSIT (1, 6, state6_enter_exec, ;, "WAKING_TO_SEND_RTS", "", "sleeping", "second contention", "tr_40", "pmac [sleeping -> second contention : WAKING_TO_SEND_RTS / ]")
				FSM_CASE_TRANSIT (2, 4, state4_enter_exec, ;, "default", "", "sleeping", "sleeping", "tr_91", "pmac [sleeping -> sleeping : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (5, "waking", state5_enter_exec, "pmac [waking enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [waking enter execs]", state5_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (5, "waking", "pmac [waking exit execs]")


			/** state (waking) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "waking", "first", "tr_57", "pmac [waking -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (second contention) enter executives **/
			FSM_STATE_ENTER_FORCED (6, "second contention", state6_enter_exec, "pmac [second contention enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [second contention enter execs]", state6_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (6, "second contention", "pmac [second contention exit execs]")


			/** state (second contention) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "second contention", "second", "tr_59", "pmac [second contention -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (wait CTS) enter executives **/
			FSM_STATE_ENTER_FORCED (7, "wait CTS", state7_enter_exec, "pmac [wait CTS enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [wait CTS enter execs]", state7_enter_exec)
				{
				//send RTS
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (7, "wait CTS", "pmac [wait CTS exit execs]")


			/** state (wait CTS) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "wait CTS", "second", "tr_89", "pmac [wait CTS -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (first) enter executives **/
			FSM_STATE_ENTER_UNFORCED (8, "first", state8_enter_exec, "pmac [first enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [first enter execs]", state8_enter_exec)
				{
				//Received DATA from upper layer
				if(FROM_UPPER)
				{
			...
			FSM_STATE_EXIT_UNFORCED (8, "first", "pmac [first exit execs]")


			/** state (first) transition processing **/
			FSM_PROFILE_SECTION_IN ("pmac [first trans conditions]", state8_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 4, state4_enter_exec, ;, "SLEEP_FROM_FIRST", "", "first", "sleeping", "tr_56", "pmac [first -> sleeping : SLEEP_FROM_FIRST / ]")
				FSM_CASE_TRANSIT (1, 12, state12_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "first", "RCV(1)", "tr_74", "pmac [first -> RCV(1) : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (2, 13, state13_enter_exec, ;, "SEND_CTS", "", "first", "wait DATA", "tr_76", "pmac [first -> wait DATA : SEND_CTS / ]")
				FSM_CASE_TRANSIT (3, 14, state14_enter_exec, ;, "SEND_ACK", "", "first", "send ACK", "tr_79", "pmac [first -> send ACK : SEND_ACK / ]")
				FSM_CASE_TRANSIT (4, 15, state15_enter_exec, ;, "CHECK_CHANNEL", "", "first", "carrier sense(1)", "tr_93", "pmac [first -> carrier sense(1) : CHECK_CHANNEL / ]")
				FSM_CASE_TRANSIT (5, 8, state8_enter_exec, ;, "default", "", "first", "first", "tr_90", "pmac [first -> first : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_UNFORCED (9, "second", state9_enter_exec, "pmac [second enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [second enter execs]", state9_enter_exec)
				{
				//Received DATA from upper layer
				if(FROM_UPPER)
				{
			...
			FSM_STATE_EXIT_UNFORCED (9, "second", "pmac [second exit execs]")


			/** state (second) transition processing **/
			FSM_PROFILE_SECTION_IN ("pmac [second trans conditions]", state9_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 7, state7_enter_exec, ;, "SEND_RTS", "", "second", "wait CTS", "tr_60", "pmac [second -> wait CTS : SEND_RTS / ]")
				FSM_CASE_TRANSIT (1, 4, state4_enter_exec, ;, "SLEEP_FROM_SECOND", "", "second", "sleeping", "tr_61", "pmac [second -> sleeping : SLEEP_FROM_SECOND / ]")
				FSM_CASE_TRANSIT (2, 10, state10_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "second", "RCV(2)", "tr_66", "pmac [second -> RCV(2) : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (3, 11, state11_enter_exec, ;, "SEND_DATA", "", "second", "send data", "tr_72", "pmac [second -> send data : SEND_DATA / ]")
				FSM_CASE_TRANSIT (4, 16, state16_enter_exec, ;, "CHECK_CHANNEL", "", "second", "carrier sense(2)", "tr_95", "pmac [second -> carrier sense(2) : CHECK_CHANNEL / ]")
				FSM_CASE_TRANSIT (5, 9, state9_enter_exec, ;, "default", "", "second", "second", "tr_92", "pmac [second -> second : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (10, "RCV(2)", state10_enter_exec, "pmac [RCV(2) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [RCV(2) enter execs]", state10_enter_exec)
				{
				if(pk_TV!=NULL)
				{
					op_pk_destroy(pk_TV);
			...
			FSM_STATE_EXIT_FORCED (10, "RCV(2)", "pmac [RCV(2) exit execs]")


			/** state (RCV(2)) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "RCV(2)", "second", "tr_71", "pmac [RCV(2) -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (send data) enter executives **/
			FSM_STATE_ENTER_FORCED (11, "send data", state11_enter_exec, "pmac [send data enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [send data enter execs]", state11_enter_exec)
				{
				//send DATA
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (11, "send data", "pmac [send data exit execs]")


			/** state (send data) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "send data", "second", "tr_73", "pmac [send data -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (RCV(1)) enter executives **/
			FSM_STATE_ENTER_FORCED (12, "RCV(1)", state12_enter_exec, "pmac [RCV(1) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [RCV(1) enter execs]", state12_enter_exec)
				{
				if(pk_TV!=NULL)
				{
					op_pk_destroy(pk_TV);
				...
				//all_rx_time = all_rx_time + time;
				if(debug)
					printf("For receiving data, Node:%d, Grade:%d, time:%f.\nReceived a packet, size: %d.\nReceive Duration is: %f.\n",	node_address,grade,op_sim_time(),pk_size,time);
			...
			FSM_STATE_EXIT_FORCED (12, "RCV(1)", "pmac [RCV(1) exit execs]")


			/** state (RCV(1)) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "RCV(1)", "first", "tr_75", "pmac [RCV(1) -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (wait DATA) enter executives **/
			FSM_STATE_ENTER_FORCED (13, "wait DATA", state13_enter_exec, "pmac [wait DATA enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [wait DATA enter execs]", state13_enter_exec)
				{
				//send CTS
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (13, "wait DATA", "pmac [wait DATA exit execs]")


			/** state (wait DATA) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "wait DATA", "first", "tr_77", "pmac [wait DATA -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (send ACK) enter executives **/
			FSM_STATE_ENTER_FORCED (14, "send ACK", state14_enter_exec, "pmac [send ACK enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [send ACK enter execs]", state14_enter_exec)
				{
				//send ACK
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (14, "send ACK", "pmac [send ACK exit execs]")


			/** state (send ACK) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "send ACK", "first", "tr_80", "pmac [send ACK -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (carrier sense(1)) enter executives **/
			FSM_STATE_ENTER_FORCED (15, "carrier sense(1)", state15_enter_exec, "pmac [carrier sense(1) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [carrier sense(1) enter execs]", state15_enter_exec)
				{
				if(debug)
				{
			...
			FSM_STATE_EXIT_FORCED (15, "carrier sense(1)", "pmac [carrier sense(1) exit execs]")


			/** state (carrier sense(1)) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "carrier sense(1)", "first", "tr_94", "pmac [carrier sense(1) -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (carrier sense(2)) enter executives **/
			FSM_STATE_ENTER_FORCED (16, "carrier sense(2)", state16_enter_exec, "pmac [carrier sense(2) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [carrier sense(2) enter execs]", state16_enter_exec)
				{
				if(debug)
			...
			FSM_STATE_EXIT_FORCED (16, "carrier sense(2)", "pmac [carrier sense(2) exit execs]")


			/** state (carrier sense(2)) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "carrier sense(2)", "second", "tr_96", "pmac [carrier sense(2) -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (start grade) enter executives **/
			FSM_STATE_ENTER_FORCED (17, "start grade", state17_enter_exec, "pmac [start grade enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac [start grade enter execs]", state17_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (17, "start grade", "pmac [start grade exit execs]")


			/** state (start grade) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "start grade", "idle", "tr_98", "pmac [start grade -> idle : default / ]")
				/*---------------------------------------------------------*/
...
void
_op_pmac_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_pmac_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_pmac_terminate ())
...
/* local variable prs_ptr in _op_pmac_svar function. */
#undef process_id
#undef node_id
#undef node_address
#undef grade
...
VosT_Obtype
_op_pmac_init (int * init_block_ptr)
	{
	VosT_Obtype obtype = OPC_NIL;
	FIN_MT (_op_pmac_init (init_block_ptr))

	obtype = Vos_Define_Object_Prstate ("proc state vars (pmac)",
		sizeof (pmac_state));
	*init_block_ptr = 0;
...
VosT_Address
_op_pmac_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	pmac_state * ptr;
	FIN_MT (_op_pmac_alloc (obtype))

	ptr = (pmac_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "pmac [init enter execs]";
#endif
		}
...
void
_op_pmac_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	{
	pmac_state		*prs_ptr;

	FIN_MT (_op_pmac_svar (gen_ptr, var_name, var_p_ptr))
