/* Process model C form file: pmac_no_routing.pr.c */
/* Portions of this file copyright 1986-2008 by OPNET Technologies, Inc. */



/* This variable carries the header into the object file */
const char pmac_no_routing_pr_c [] = "MIL_3_Tfile_Hdr_ 145A 30A modeler 7 51C4CEE7 51C4CEE7 1 wpd FeiTong 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 1e80 8                                                                                                                                                                                                                                                                                                                                                                                                              ";
#include <string.h>
...
#define FIN_PREAMBLE_DEC	pmac_no_routing_state *op_sv_ptr;
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((pmac_no_routing_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
extern "C" {
#endif
	void pmac_no_routing (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Obtype _op_pmac_no_routing_init (int * init_block_ptr);
	void _op_pmac_no_routing_diag (OP_SIM_CONTEXT_ARG_OPT);
	void _op_pmac_no_routing_terminate (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Address _op_pmac_no_routing_alloc (VosT_Obtype, int);
	void _op_pmac_no_routing_svar (void *, const char *, void **);
...
void
pmac_no_routing (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (pmac_no_routing ());
		...
		FSM_ENTER ("pmac_no_routing")

		FSM_BLOCK_SWITCH
			{
			/*---------------------------------------------------------*/
			/** state (init) enter executives **/
			FSM_STATE_ENTER_FORCED_NOLABEL (0, "init", "pmac_no_routing [init enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [init enter execs]", state0_enter_exec)
				{
				// Obtain related ID
			...
			FSM_STATE_EXIT_FORCED (0, "init", "pmac_no_routing [init exit execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [init exit execs]", state0_exit_exec)
				{
				/*
			...
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "init", "idle", "tr_1", "pmac_no_routing [init -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (idle) enter executives **/
			FSM_STATE_ENTER_UNFORCED (1, "idle", state1_enter_exec, "pmac_no_routing [idle enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [idle enter execs]", state1_enter_exec)
				{
				if(END)
				{
				/*
			...
			FSM_EXIT (3,"pmac_no_routing")


			/** state (idle) exit executives **/
			FSM_STATE_EXIT_UNFORCED (1, "idle", "pmac_no_routing [idle exit execs]")


			/** state (idle) transition processing **/
			FSM_PROFILE_SECTION_IN ("pmac_no_routing [idle trans conditions]", state1_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 6, state6_enter_exec, ;, "CONTEND_TO_SEND_RTS", "", "idle", "second contention", "tr_28", "pmac_no_routing [idle -> second contention : CONTEND_TO_SEND_RTS / ]")
				FSM_CASE_TRANSIT (1, 4, state4_enter_exec, ;, "GO_TO_SLEEP", "", "idle", "sleeping", "tr_32", "pmac_no_routing [idle -> sleeping : GO_TO_SLEEP / ]")
				FSM_CASE_TRANSIT (2, 5, state5_enter_exec, ;, "WAKING_TO_WAIT_RTS", "", "idle", "waking", "tr_34", "pmac_no_routing [idle -> waking : WAKING_TO_WAIT_RTS / ]")
				FSM_CASE_TRANSIT (3, 17, state17_enter_exec, ;, "START_GRADE", "", "idle", "start grade", "tr_97", "pmac_no_routing [idle -> start grade : START_GRADE / ]")
				FSM_CASE_TRANSIT (4, 3, state3_enter_exec, ;, "SEND_GM", "", "idle", "send gm", "tr_100", "pmac_no_routing [idle -> send gm : SEND_GM / ]")
				FSM_CASE_TRANSIT (5, 2, state2_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "idle", "GM proc", "tr_102", "pmac_no_routing [idle -> GM proc : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (6, 1, state1_enter_exec, ;, "default", "", "idle", "idle", "tr_99", "pmac_no_routing [idle -> idle : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (2, "GM proc", state2_enter_exec, "pmac_no_routing [GM proc enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [GM proc enter execs]", state2_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (2, "GM proc", "pmac_no_routing [GM proc exit execs]")


			/** state (GM proc) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "GM proc", "idle", "tr_103", "pmac_no_routing [GM proc -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (send gm) enter executives **/
			FSM_STATE_ENTER_FORCED (3, "send gm", state3_enter_exec, "pmac_no_routing [send gm enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [send gm enter execs]", state3_enter_exec)
				{
				if(op_subq_empty(grade_queue) == OPC_FALSE)
				{
			...
			FSM_STATE_EXIT_FORCED (3, "send gm", "pmac_no_routing [send gm exit execs]")


			/** state (send gm) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send gm", "idle", "tr_101", "pmac_no_routing [send gm -> idle : default / ]")
				/*---------------------------------------------------------*/



			/** state (sleeping) enter executives **/
			FSM_STATE_ENTER_UNFORCED (4, "sleeping", state4_enter_exec, "pmac_no_routing [sleeping enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [sleeping enter execs]", state4_enter_exec)
				{
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (9,"pmac_no_routing")


			/** state (sleeping) exit executives **/
			FSM_STATE_EXIT_UNFORCED (4, "sleeping", "pmac_no_routing [sleeping exit execs]")


			/** state (sleeping) transition processing **/
			FSM_PROFILE_SECTION_IN ("pmac_no_routing [sleeping trans conditions]", state4_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 5, state5_enter_exec, ;, "WAKING_UP", "", "sleeping", "waking", "tr_37", "pmac_no_routing [sleeping -> waking : WAKING_UP / ]")
				FSM_CASE_TRANSIT (1, 6, state6_enter_exec, ;, "WAKING_TO_SEND_RTS", "", "sleeping", "second contention", "tr_40", "pmac_no_routing [sleeping -> second contention : WAKING_TO_SEND_RTS / ]")
				FSM_CASE_TRANSIT (2, 4, state4_enter_exec, ;, "default", "", "sleeping", "sleeping", "tr_91", "pmac_no_routing [sleeping -> sleeping : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (5, "waking", state5_enter_exec, "pmac_no_routing [waking enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [waking enter execs]", state5_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (5, "waking", "pmac_no_routing [waking exit execs]")


			/** state (waking) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "waking", "first", "tr_57", "pmac_no_routing [waking -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (second contention) enter executives **/
			FSM_STATE_ENTER_FORCED (6, "second contention", state6_enter_exec, "pmac_no_routing [second contention enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [second contention enter execs]", state6_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (6, "second contention", "pmac_no_routing [second contention exit execs]")


			/** state (second contention) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "second contention", "second", "tr_59", "pmac_no_routing [second contention -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (wait CTS) enter executives **/
			FSM_STATE_ENTER_FORCED (7, "wait CTS", state7_enter_exec, "pmac_no_routing [wait CTS enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [wait CTS enter execs]", state7_enter_exec)
				{
				//send RTS
				if(pk_TV!=NULL)
				{
				...
				{
					op_sim_end("Routing table is empty Err: Are you kidding me?","","","");
				}
			...
			FSM_STATE_EXIT_FORCED (7, "wait CTS", "pmac_no_routing [wait CTS exit execs]")


			/** state (wait CTS) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "wait CTS", "second", "tr_89", "pmac_no_routing [wait CTS -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (first) enter executives **/
			FSM_STATE_ENTER_UNFORCED (8, "first", state8_enter_exec, "pmac_no_routing [first enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [first enter execs]", state8_enter_exec)
				{
				//Received DATA from upper layer
				if(FROM_UPPER)
				{
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (17,"pmac_no_routing")


			/** state (first) exit executives **/
			FSM_STATE_EXIT_UNFORCED (8, "first", "pmac_no_routing [first exit execs]")


			/** state (first) transition processing **/
			FSM_PROFILE_SECTION_IN ("pmac_no_routing [first trans conditions]", state8_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 4, state4_enter_exec, ;, "SLEEP_FROM_FIRST", "", "first", "sleeping", "tr_56", "pmac_no_routing [first -> sleeping : SLEEP_FROM_FIRST / ]")
				FSM_CASE_TRANSIT (1, 12, state12_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "first", "RCV(1)", "tr_74", "pmac_no_routing [first -> RCV(1) : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (2, 13, state13_enter_exec, ;, "SEND_CTS", "", "first", "wait DATA", "tr_76", "pmac_no_routing [first -> wait DATA : SEND_CTS / ]")
				FSM_CASE_TRANSIT (3, 14, state14_enter_exec, ;, "SEND_ACK", "", "first", "send ACK", "tr_79", "pmac_no_routing [first -> send ACK : SEND_ACK / ]")
				FSM_CASE_TRANSIT (4, 15, state15_enter_exec, ;, "CHECK_CHANNEL", "", "first", "carrier sense(1)", "tr_93", "pmac_no_routing [first -> carrier sense(1) : CHECK_CHANNEL / ]")
				FSM_CASE_TRANSIT (5, 8, state8_enter_exec, ;, "default", "", "first", "first", "tr_90", "pmac_no_routing [first -> first : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_UNFORCED (9, "second", state9_enter_exec, "pmac_no_routing [second enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [second enter execs]", state9_enter_exec)
				{
				//Received DATA from upper layer
				if(FROM_UPPER)
				{
			...
			/** blocking after enter executives of unforced state. **/
			FSM_EXIT (19,"pmac_no_routing")


			/** state (second) exit executives **/
			FSM_STATE_EXIT_UNFORCED (9, "second", "pmac_no_routing [second exit execs]")


			/** state (second) transition processing **/
			FSM_PROFILE_SECTION_IN ("pmac_no_routing [second trans conditions]", state9_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 7, state7_enter_exec, ;, "SEND_RTS", "", "second", "wait CTS", "tr_60", "pmac_no_routing [second -> wait CTS : SEND_RTS / ]")
				FSM_CASE_TRANSIT (1, 4, state4_enter_exec, ;, "SLEEP_FROM_SECOND", "", "second", "sleeping", "tr_61", "pmac_no_routing [second -> sleeping : SLEEP_FROM_SECOND / ]")
				FSM_CASE_TRANSIT (2, 10, state10_enter_exec, ;, "FROM_LOWER && transceiver_state", "", "second", "RCV(2)", "tr_66", "pmac_no_routing [second -> RCV(2) : FROM_LOWER && transceiver_state / ]")
				FSM_CASE_TRANSIT (3, 11, state11_enter_exec, ;, "SEND_DATA", "", "second", "send data", "tr_72", "pmac_no_routing [second -> send data : SEND_DATA / ]")
				FSM_CASE_TRANSIT (4, 16, state16_enter_exec, ;, "CHECK_CHANNEL", "", "second", "carrier sense(2)", "tr_95", "pmac_no_routing [second -> carrier sense(2) : CHECK_CHANNEL / ]")
				FSM_CASE_TRANSIT (5, 9, state9_enter_exec, ;, "default", "", "second", "second", "tr_92", "pmac_no_routing [second -> second : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (10, "RCV(2)", state10_enter_exec, "pmac_no_routing [RCV(2) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [RCV(2) enter execs]", state10_enter_exec)
				{
				if(pk_TV!=NULL)
				{
					op_pk_destroy(pk_TV);
			...
			FSM_STATE_EXIT_FORCED (10, "RCV(2)", "pmac_no_routing [RCV(2) exit execs]")


			/** state (RCV(2)) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "RCV(2)", "second", "tr_71", "pmac_no_routing [RCV(2) -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (send data) enter executives **/
			FSM_STATE_ENTER_FORCED (11, "send data", state11_enter_exec, "pmac_no_routing [send data enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [send data enter execs]", state11_enter_exec)
				{
				//send DATA
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (11, "send data", "pmac_no_routing [send data exit execs]")


			/** state (send data) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "send data", "second", "tr_73", "pmac_no_routing [send data -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (RCV(1)) enter executives **/
			FSM_STATE_ENTER_FORCED (12, "RCV(1)", state12_enter_exec, "pmac_no_routing [RCV(1) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [RCV(1) enter execs]", state12_enter_exec)
				{
				if(pk_TV!=NULL)
				{
					op_pk_destroy(pk_TV);
			...
			FSM_STATE_EXIT_FORCED (12, "RCV(1)", "pmac_no_routing [RCV(1) exit execs]")


			/** state (RCV(1)) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "RCV(1)", "first", "tr_75", "pmac_no_routing [RCV(1) -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (wait DATA) enter executives **/
			FSM_STATE_ENTER_FORCED (13, "wait DATA", state13_enter_exec, "pmac_no_routing [wait DATA enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [wait DATA enter execs]", state13_enter_exec)
				{
				//send CTS
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (13, "wait DATA", "pmac_no_routing [wait DATA exit execs]")


			/** state (wait DATA) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "wait DATA", "first", "tr_77", "pmac_no_routing [wait DATA -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (send ACK) enter executives **/
			FSM_STATE_ENTER_FORCED (14, "send ACK", state14_enter_exec, "pmac_no_routing [send ACK enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [send ACK enter execs]", state14_enter_exec)
				{
				//send ACK
				if(pk_TV!=NULL)
				{
			...
			FSM_STATE_EXIT_FORCED (14, "send ACK", "pmac_no_routing [send ACK exit execs]")


			/** state (send ACK) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "send ACK", "first", "tr_80", "pmac_no_routing [send ACK -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (carrier sense(1)) enter executives **/
			FSM_STATE_ENTER_FORCED (15, "carrier sense(1)", state15_enter_exec, "pmac_no_routing [carrier sense(1) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [carrier sense(1) enter execs]", state15_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (15, "carrier sense(1)", "pmac_no_routing [carrier sense(1) exit execs]")


			/** state (carrier sense(1)) transition processing **/
			FSM_TRANSIT_FORCE (8, state8_enter_exec, ;, "default", "", "carrier sense(1)", "first", "tr_94", "pmac_no_routing [carrier sense(1) -> first : default / ]")
				/*---------------------------------------------------------*/



			/** state (carrier sense(2)) enter executives **/
			FSM_STATE_ENTER_FORCED (16, "carrier sense(2)", state16_enter_exec, "pmac_no_routing [carrier sense(2) enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [carrier sense(2) enter execs]", state16_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (16, "carrier sense(2)", "pmac_no_routing [carrier sense(2) exit execs]")


			/** state (carrier sense(2)) transition processing **/
			FSM_TRANSIT_FORCE (9, state9_enter_exec, ;, "default", "", "carrier sense(2)", "second", "tr_96", "pmac_no_routing [carrier sense(2) -> second : default / ]")
				/*---------------------------------------------------------*/



			/** state (start grade) enter executives **/
			FSM_STATE_ENTER_FORCED (17, "start grade", state17_enter_exec, "pmac_no_routing [start grade enter execs]")
				FSM_PROFILE_SECTION_IN ("pmac_no_routing [start grade enter execs]", state17_enter_exec)
				{
			...
			FSM_STATE_EXIT_FORCED (17, "start grade", "pmac_no_routing [start grade exit execs]")


			/** state (start grade) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "start grade", "idle", "tr_98", "pmac_no_routing [start grade -> idle : default / ]")
				/*---------------------------------------------------------*/
...
void
_op_pmac_no_routing_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_pmac_no_routing_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_pmac_no_routing_terminate ())
...
/* local variable prs_ptr in _op_pmac_no_routing_svar function. */
#undef process_id
#undef node_id
#undef node_address
#undef grade
...
VosT_Obtype
_op_pmac_no_routing_init (int * init_block_ptr)
	{
	VosT_Obtype obtype = OPC_NIL;
	FIN_MT (_op_pmac_no_routing_init (init_block_ptr))

	obtype = Vos_Define_Object_Prstate ("proc state vars (pmac_no_routing)",
		sizeof (pmac_no_routing_state));
	*init_block_ptr = 0;
...
VosT_Address
_op_pmac_no_routing_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	pmac_no_routing_state * ptr;
	FIN_MT (_op_pmac_no_routing_alloc (obtype))

	ptr = (pmac_no_routing_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "pmac_no_routing [init enter execs]";
#endif
		}
...
void
_op_pmac_no_routing_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	{
	pmac_no_routing_state		*prs_ptr;

	FIN_MT (_op_pmac_no_routing_svar (gen_ptr, var_name, var_p_ptr))
	...
	prs_ptr = (pmac_no_routing_state *)gen_ptr;
